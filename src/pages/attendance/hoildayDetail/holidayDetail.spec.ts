...
import { HoildayDetailPage } from './hoildayDetail';
import { ConfigMock, PlatformMock, NavMock } from '../../../mocks';

describe('HoildayDetailPage', () => {

  let comp: HoildayDetailPage;
  let fixture: ComponentFixture<HoildayDetailPage>;
  let de: DebugElement;
  let el: any;
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [HoildayDetailPage], // declare the test component
      providers: [
    ...
    fixture = TestBed.createComponent(HoildayDetailPage);
